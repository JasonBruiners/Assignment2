...
### 3.4.1 Structural Topic Modelling
#### New24
```{r echo=FALSE}
#News24 STM Plot
News24_top_terms %>%
...
## Frequency of tweets by selected media agencies over a three week period
```{r echo=FALSE}
#frequency of tweets
...
## Retweet count by selected media agencies over a three week period
```{r echo=FALSE}
#retweet Count
...
## Like Count by selected media agencies over a three week period
```{r echo=FALSE}
#Like Count
...
## Covid 19 tweets by selected media vs other tweeted news
```{r echo=FALSE}
...
## Tweets of selected media vs rest of RSA
```{r echo=FALSE}
# Media Vs others
...
## Follower count of selected media
```{r echo=FALSE}
# follower count on 22nd
ggplot(Followers_media, aes(x=Media,y=followers_count)) + geom_bar(stat = "identity", color = "black", fill = "red") + scale_y_continuous(label = comma) + Other_theme + labs(x = NULL, y = NULL, title = "Follower Count", subtitle = "Latest update: 22 June", caption = "\nSource: Data collected from Twitter's REST API via rtweet")

```

## Tweet distribution in RSA
```{r echo=FALSE}
...
## mp visualisation of tweet distribution
```{r echo=FALSE}
