...
tweets_za_13 <- search_tweets(q,geocode = lookup_coords("South Africa"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)

#Collecting tweets for largest city in each province
tweets_bloem_13 <- search_tweets(q,geocode = lookup_coords("Bloemfontein"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_cpt_13 <- search_tweets(q,geocode = lookup_coords("Cape Town"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_durb_13 <- search_tweets(q,geocode = lookup_coords("Durban"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_jhb_13 <- search_tweets(q,geocode = lookup_coords("Johannesburg"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_kim_13 <- search_tweets(q,geocode = lookup_coords("Kimberley"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_klerk_13 <- search_tweets(q,geocode = lookup_coords("Klerksdorp"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_mbomb_13 <- search_tweets(q,geocode = lookup_coords("Mbombela"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_polo_13 <- search_tweets(q,geocode = lookup_coords("Polokwane"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
tweets_pe_13 <- search_tweets(q,geocode = lookup_coords("Port Elizabeth"), since="2020-06-13", until="2020-06-14", type="recent", include_rts=FALSE, n=18000)
```
...
```{r}
#Export Filtered Data for 13/06/2020
write_rds(tweets_za_13, "Data/Raw_Filtered_Data/tweets_za_13.rds")
write_rds(tweets_bloem_13, "Data/Raw_Filtered_Data/tweets_bloem_13.rds")
write_rds(tweets_cpt_13, "Data/Raw_Filtered_Data/tweets_cpt_13.rds")
write_rds(tweets_durb_13, "Data/Raw_Filtered_Data/tweets_durb_13.rds")
write_rds(tweets_jhb_13, "Data/Raw_Filtered_Data/tweets_jhb_13.rds")
write_rds(tweets_kim_13, "Data/Raw_Filtered_Data/tweets_kim_13.rds")
write_rds(tweets_klerk_13, "Data/Raw_Filtered_Data/tweets_klerk_13.rds")
write_rds(tweets_mbomb_13, "Data/Raw_Filtered_Data/tweets_mbomb_13.rds")
write_rds(tweets_polo_13, "Data/Raw_Filtered_Data/tweets_polo_13")
write_rds(tweets_pe_13, "Data/Raw_Filtered_Data/tweets_pe_13")

#Export All Tweet Data for 13/06/2020
```
