...
News24_cleaned$stripped_text <- gsub("http\\S+", "", News24_cleaned$text) 
News24_cleaned$stripped_text <- gsub("@\\S*","", News24_cleaned$text) 
News24_cleaned$stripped_text <- gsub("amp","", News24_cleaned$text) 
