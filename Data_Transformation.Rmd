...
tweets.News24_sub_clean <- tweets.News24_clean %>% tweets.SABCNews_clean[grep("covid|corona|covid 19|covid19|coronavirus|sars cov 2|sars cov" ,tweets.SABCNews_clean$stripped_text),]
