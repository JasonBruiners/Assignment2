...
news24_plot <- afinn_news24 %>% top_n(10) %>% mutate(word = reorder(word,n)) %>% ggplot(aes(x= word, y = n)) + geom_col() + coord_flip() + sentiment_theme + labs(x = NULL, y = NULL, title = "News24 Frequently Used Words", subtitle = "Top 10", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
news24_plot 

ggplot(news24_score, aes(x=value,y=count)) + geom_bar(stat = "identity") + sentiment_theme + scale_x_continuous(breaks = c(-4,-3,-2,-1,0,1,2,3,4)) + labs(x = NULL, y = NULL, title = "News24 Sentiment Score", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
...
TimesLIVE_plot <- afinn_TimesLIVE %>% top_n(10) %>% mutate(word = reorder(word,n)) %>% ggplot(aes(x= word, y = n)) + geom_col() + coord_flip() + sentiment_theme + labs(x = NULL, y = NULL, title = "TimesLIVE Frequently Used Words", subtitle = "Top 10", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
TimesLIVE_plot 

ggplot(TimesLIVE_score, aes(x=value,y=count)) + geom_bar(stat = "identity") + sentiment_theme + scale_x_continuous(breaks = c(-4,-3,-2,-1,0,1,2,3,4)) + labs(x = NULL, y = NULL, title = "TimesLIVE Sentiment Score", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
...
eNCA_plot <- afinn_eNCA %>% top_n(10) %>% mutate(word = reorder(word,n)) %>% ggplot(aes(x= word, y = n)) + geom_col() + coord_flip() + sentiment_theme + labs(x = NULL, y = NULL, title = "eNCA Frequently Used Words", subtitle = "Top 10", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
eNCA_plot 

ggplot(eNCA_score, aes(x=value,y=count)) + geom_bar(stat = "identity") + sentiment_theme + scale_x_continuous(breaks = c(-4,-3,-2,-1,0,1,2,3,4)) + labs(x = NULL, y = NULL, title = "eNCA Sentiment Score", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
...
IOL_plot <- afinn_IOL %>% top_n(10) %>% mutate(word = reorder(word,n)) %>% ggplot(aes(x= word, y = n)) + geom_col() + coord_flip() + sentiment_theme + labs(x = NULL, y = NULL, title = "IOL Frequently Used Words", subtitle = "Top 10", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
IOL_plot 

ggplot(IOL_score, aes(x=value,y=count)) + geom_bar(stat = "identity") + sentiment_theme + scale_x_continuous(breaks = c(-4,-3,-2,-1,0,1,2,3,4)) + labs(x = NULL, y = NULL, title = "IOL Sentiment Score", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
...
ewn_plot <- afinn_ewn %>% top_n(10) %>% mutate(word = reorder(word,n)) %>% ggplot(aes(x= word, y = n)) + geom_col() + coord_flip() + sentiment_theme + labs(x = NULL, y = NULL, title = "EWN Frequently Used Words", subtitle = "Top 10", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
ewn_plot 

ggplot(ewn_score, aes(x=value,y=count)) + geom_bar(stat = "identity") + sentiment_theme + scale_x_continuous(breaks = c(-4,-3,-2,-1,0,1,2,3,4)) + labs(x = NULL, y = NULL, title = "EWN Sentiment Score", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
...
SABC_plot <- afinn_SABCNews %>% top_n(10) %>% mutate(word = reorder(word,n)) %>% ggplot(aes(x= word, y = n)) + geom_col() + coord_flip() + sentiment_theme + labs(x = NULL, y = NULL, title = "SABCNews Frequently Used Words", subtitle = "Top 10", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
SABC_plot 

ggplot(SABC_score, aes(x=value,y=count)) + geom_bar(stat = "identity") + sentiment_theme + scale_x_continuous(breaks = c(-4,-3,-2,-1,0,1,2,3,4)) + labs(x = NULL, y = NULL, title = "SABCNews Sentiment Score", caption = "\nSource: Data collected from Twitter's REST API via rtweet")
...
doc.length = apply(dtmNews24, 1, sum)
dtmNews24 = dtmNews24[doc.length > 0,]
...
doc.length = apply(dtmTimesLIVE, 1, sum)
dtmTimesLIVE = dtmTimesLIVE[doc.length > 0,]
...
#####################################################################################################################
```{r}
First_STM <- stm(documents = News24_docs, vocab = News24_vocab,
              K = 12, max.em.its = 75, data = News24_meta,
              init.type = "Spectral", verbose = FALSE)

Second_STM <- stm(documents = News24_docs, vocab = News24_vocab,
              K = 16, max.em.its = 75, data = News24_meta,
              init.type = "Spectral", verbose = FALSE)

Third_STM <- stm(documents = News24_docs, vocab = News24_vocab,
              K = 20, max.em.its = 75, data = News24_meta,
              init.type = "Spectral", verbose = FALSE)
```
...
```{r}
News24_topics <- tidy(First_STM, matrix = "beta")
...
News24_topics2 <- tidy(Second_STM, matrix = "beta")
...
News24_topics3 <- tidy(Third_STM, matrix = "beta")
