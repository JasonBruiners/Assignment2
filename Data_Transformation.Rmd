...
#=======
News24_cleaned <- News24_tweets %>% select(screen_name, text)
News24_cleaned$stripped_text <- gsub("http\\S+", "", News24_cleaned$stripped_text) 
News24_cleaned$stripped_text <- gsub("@\\S*","", News24_cleaned$stripped_text) 
News24_cleaned$stripped_text <- gsub("amp","", News24_cleaned$stripped_text) 
News24_cleaned$stripped_text <- gsub("[\r\n]","", News24_cleaned$stripped_text)
#>>>>>>> Stashed changes
...
corpus <- Corpus(VectorSource(News24_tweets$text))
